...
public class GoodsClassifyServices {
    ...
    public AppResponse updateGoodsClassify(GoodsClassifyInfo goodsClassifyInfo){
        ...
        goodsClassifyInfo.setOldVersion(goodsClassifyInfo.getVersion());
        goodsClassifyInfo.setVersion(String.valueOf(Integer.parseInt(goodsClassifyInfo.getVersion())+1));
